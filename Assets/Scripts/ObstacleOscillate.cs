...
public class ObstacleOscillate : MonoBehaviour {
	...
	void Start () {
        m_Player = FindObjectOfType<PlayerBehavior>();
	}
    ...
    private void StartOsc()
    {
        ...
        Wrj.Utils.MapToCurve.EaseIn.MoveWorld(transform, targetPos, rate, mirrorCurve: true, mirrorPingPong: 1, useTimeScale: true, onDone: StartOsc);
